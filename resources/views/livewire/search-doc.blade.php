                            ...
                            @forelse($results as $result)
                                <div class="col-12">
                                    <div class="single-main">
                                        <a class="download mef1" wire:navigate href="{{route('docsDetail', $result->id)}}">
                                        @if ($result->doc_image != '')
                                            <div class="news-head">
                                                <img src="{{asset('storage/'.$result->doc_image) }}" alt="#">
                                            </div>
                                        @endif
                                        ...
                                        <div class="meta">
                                            ...
                                            <div class="meta-right">
                                                <div class="table-bottom">
                                                    <a class="download mef1" wire:navigate href="{{route('docsDetail', $result->id)}}"><i class="fa fa-eye"></i> {{__('frontend.view')}}</a>
                                                    @if($result->doc_file != '')<a class="download mef1" wire:click="download({{$result->id}})"><i class="fa fa-download"></i> {{__('frontend.doc_download')}}</a>@endif
                                                </div>
                                            </div>
                                        </div>
                                        </a>
